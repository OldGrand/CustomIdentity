...
namespace CustomIdentity.BLL.Security
{
    public class LookupProtector : ILookupProtector
    {
        ...
        private byte[] SignData(byte[] cipherText, byte[] masterKey, SymmetricAlgorithm symmetricAlgorithm,
        ...
        private byte[] DerivedInitializationVector(byte[] key, string plainText, SymmetricAlgorithm algorithm,
